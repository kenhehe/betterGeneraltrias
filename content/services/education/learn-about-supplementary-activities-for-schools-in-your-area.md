# Learn About Supplementary Activities for Schools in Your Area — Tagaytay City

This guide shows where to find **clubs, student organizations, competitions, service groups, and enrichment programs** available to learners in Tagaytay City.
...
2. **DepEd Tagaytay City Division** — division-wide contests, trainings, and circulars:
   - Website: https://deped.tagaytay.gov.ph/
   - FB page: https://www.facebook.com/DepEDLLC/
3. **City facilities** — the **Tagaytay City e-Library (Tagaytay City Sports Complex, Kaybagal South)** runs study support and computer/printing access (open daily 8:00 a.m.–12:00 midnight):
   - SunStar article: https://www.tagaytay.gov.ph/lapu-lapu-city-reopens-e-library
...
| **Campus Journalism (School Papers)**                     | Writing, editing, layout, radio/TV script, participation in press conferences       | Start with your English/Filipino department; division circulars are posted on DepEd Tagaytay City site/FB                          |
...
- **ALS (Alternative Learning System)** — if you’re out-of-school youth or need flexible learning.
  - DepEd Tagaytay City Division contact page lists ALS focal persons: https://deped.tagaytay.gov.ph/contact-us/
- **City e-Library Programs** — occasional **digital skills** and study support activities (ask staff at Tagaytay City Sports Complex).
...
5. **Track division-level announcements** via DepEd Tagaytay City for contests and training invitations.
...
- DepEd Tagaytay City Division — https://deped.tagaytay.gov.ph/
- DepEd Tagaytay City FB — https://www.facebook.com/DepEDLLC/
- Tagaytay City e-Library news — https://www.tagaytay.gov.ph/lapu-lapu-city-reopens-e-library
