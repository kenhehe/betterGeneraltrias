...
const Government: React.FC = () => {
  ...
  if (!category) {
    return (
      <>
        <SEO
          title="Government"
          description={`Government departments, offices, and transparency documents for ${import.meta.env.VITE_GOVERNMENT_NAME}.`}
          keywords="government departments, local government, officials, transparency"
        />
        <GovernmentActivitySection
          title="General Trias City Government"
          description={`Government departments, offices, and public records for ${import.meta.env.VITE_GOVERNMENT_NAME}.`}
        />
      </>
    );
  }
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-500 mb-6">
          The government category you are looking for does not exist.
        </p>
        <Link
          to="/government"
  ...
  const BREADCRUMBS = [
    ...
    { label: categoryData.category, href: `/government/${category}` },
  ];
  ...
  return (
    <>
      <SEO
        ...
        keywords={`${categoryData.category}, General Trias government, local government`}
      />
